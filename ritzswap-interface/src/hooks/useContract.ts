...
export function useWETHContract(withSignerIfPossible?: boolean): Contract | null {
  ...
  return useContract("0x61dF61547b7ceAF9671368649960dC226f47A7Dc", WETH_ABI, withSignerIfPossible)
}
...
export function useSocksController(): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId === ChainId.MATIC ? undefined : undefined, UNISOCKS_ABI, false)
}
