import { Token } from 'nightmare-sdk'
...
import { getMaticLink, shortenAddress } from '../../utils' // changed to getMaticLink
    ...
    <Wrapper error={duplicateNameOrSymbol}>
      <AutoRow gap="6px">
        ...
        <AutoColumn gap="10px" justify="flex-start">
          ...
          {chainId && (
            <ExternalLink style={{ fontWeight: 400 }} href={getMaticLink(chainId, token.address, 'token')}>
              <Text title={token.address}>
                {shortenAddress(token.address)} {TranslateString(116, '(View on Matic Explorer)')}
              </Text>
            </ExternalLink>
          )}
        </AutoColumn>
