import { CurrencyAmount, JSBI, Token, Trade } from 'nightmare-sdk'
              ...
              {!account ? (
                ...
                <RowBetween>
                  <Button
                    ...
                    style={{ width: '48%' }}
                    variant={approval === ApprovalState.APPROVED ? 'success' : 'subtle'}
                  >
                    {approval === ApprovalState.PENDING ? (
                  ...
                  <Button
                    ...
                    variant={isValid && priceImpactSeverity > 2 ? 'danger' : 'subtle'}
                  >
                    {priceImpactSeverity > 3 && !isExpertMode
                      ? `Price Impact High`
