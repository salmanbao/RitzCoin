...
import { useFarms, usePriceMaticBusd, usePriceCakeBusd, usePriceEthBusd } from 'state/hooks'
...
const Farms: React.FC = () => {
  ...
  const farmsList = useCallback(
    (farmsToDisplay: Farm[]): FarmWithStakedValue[] => {
      ...
      let farmsToDisplayWithAPY: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        if (farm.quoteToken.symbol === tokens.busd.symbol || farm.quoteToken.symbol === tokens.usdt.symbol) {
          apy = cakePriceVsBNB.times(cakeRewardPerYear).div(farm.lpTotalInQuoteToken).times(maticPrice)
        } 
        ...
        if (farm.quoteToken.symbol === tokens.wmatic.symbol) {
          liquidity = maticPrice.times(farm.lpTotalInQuoteToken)
        }
    ...
    [maticPrice, farmsLP, query, cakePrice, ethPriceUsd],
  )
    ...
    <>
      ...
      <div className={ isDark ? "menu-theme-dark" :  "menu-theme-dark" }>
        ...
        {/* <div className={ isDark ? "menu-theme-dark" :  "menu-theme" }> */}
          <Header>
              <Heading as="h1" size="xxl"  mb="5px" className="" >
