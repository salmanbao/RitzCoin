...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, maticPrice, ethPrice, account }) => {
  ...
  }, [maticPrice, cakePrice, ethPrice, farm.lpTotalInQuoteToken, farm.quoteToken.symbol])
  ...
  return (
    <FCard>
      ...
      <ExpandingWrapper expanded={showExpandableSection}>
        <DetailsSection
          removed={removed}
          maticAddress={`https://explorer-mumbai.maticvigil.com/address/${farm.lpAddresses[process.env.REACT_APP_CHAIN_ID]}`}
