...
const StyledLotteryCard = styled(Card)`
  background-image: url('/images/devil.svg');
...
const FarmedStakingCard = () => {
  ...
  const renderLotteryTicketButtonBuyOrApprove = () => {
    if (!allowance.toNumber()) {
      return (
        <Button width="100%" variant="subtle" disabled={requestedApproval} onClick={handleApprove} className="Approvebtn">
  ...
  return (
    <StyledLotteryCard>
      <CardBody>
        ...
        <CardImage src="/images/ticket.svg" alt="cake logo" style={{opacity:"0"}} width={64} height={64} />
        <Block>
          <Label>{TranslateString(552, 'NGT to Collect')}:</Label>
          <CakeWinnings />
        </Block>
        <Block>
